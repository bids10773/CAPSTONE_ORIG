<x-email.layout title="Medical Examination Referral" preheader="{{ $companyName }} invited you to complete a medical examination." :logo-src="$message->embed(public_path('images/email-logo-optimized.png'))">
