<x-email.layout title="Response to Your Inquiry" preheader="Living Myth Industrial Clinic responded to your inquiry." :logo-src="$message->embed(public_path('images/email-logo-optimized.png'))">
