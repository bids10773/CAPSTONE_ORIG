<x-email.layout title="Inquiry Received" preheader="Living Myth Industrial Clinic has received your inquiry." :logo-src="$message->embed(public_path('images/email-logo-optimized.png'))">
