<x-email.layout title="Your Staff Account Is Ready" preheader="Your secure staff account has been created." :logo-src="$message->embed(public_path('images/email-logo-optimized.png'))" :system-name="$systemName">
