<x-email.layout title="Password Successfully Changed" preheader="The password for your clinic account was recently changed." :logo-src="$message->embed(public_path('images/email-logo-optimized.png'))">
