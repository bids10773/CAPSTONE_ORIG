            ...
            <div className="overflow-x-auto rounded-xl border bg-white shadow-sm">
                <table className="w-full min-w-[720px] text-left text-sm">
                    <thead className="bg-slate-50 text-xs text-slate-500 uppercase">
                        <tr>
                            ...
                            <th className="px-5 py-3">Employee no.</th>
                        ...
                        {queues.data.map((queue) => (
                            <tr key={queue.id} className="hover:bg-slate-50">
                                ...
                                <td className="px-5 py-4">
                                    {queue.appointment.patient_profile
                                        ?.employee_number ?? '—'}
                                </td>
                                <td className="px-5 py-4">
                ...
                {queues.data.length === 0 && (
                    <p className="p-10 text-center text-sm text-slate-500">
                        No employees are assigned to your queue for this event.
                    </p>
                )}
            </div>
...
StaffOnsiteEvent.layout = (page: React.ReactNode) => (
